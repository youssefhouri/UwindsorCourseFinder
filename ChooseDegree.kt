...
class ChooseDegree : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CourseParser {
            ...
            undergradCal = Jsoup.connect("http://web4.uwindsor.ca/units/registrar/calendars/undergraduate/fall2019.nsf/982f0e5f06b5c9a285256d6e006cff78/40a4d00a28a9d3e685257362006c8367!OpenDocument").userAgent("Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.0) Gecko/20100101 Firefox/25.0")
                .referrer("http://www.google.com/%22")
                    .ignoreHttpErrors(true).get();
            compsciCourses = Jsoup.connect("http://web4.uwindsor.ca/units/registrar/calendars/undergraduate/fall2019.nsf/982f0e5f06b5c9a285256d6e006cff78/fb6695172a9a1ba385257364004a8752!OpenDocument").userAgent("Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.0) Gecko/20100101 Firefox/25.0")
                .referrer("http://www.google.com/%22")
                .ignoreHttpErrors(true).get();
            mathstatCourses = Jsoup.connect("http://web4.uwindsor.ca/units/registrar/calendars/undergraduate/fall2019.nsf/982f0e5f06b5c9a285256d6e006cff78/fb6695172a9a1ba385257364004a8752!OpenDocument").userAgent("Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:25.0) Gecko/20100101 Firefox/25.0")
                .referrer("http://www.google.com/%22")
                .ignoreHttpErrors(true).get();
