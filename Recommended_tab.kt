...
class Recommended_tab : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CourseParser {
            ...
            var undergradCal: Document = Jsoup.connect("http://web4.uwindsor.ca/units/registrar/calendars/undergraduate/fall2019.nsf/982f0e5f06b5c9a285256d6e006cff78/40a4d00a28a9d3e685257362006c8367!OpenDocument").get()
    ...
    fun updateList(){
        ...
        courseListAdapter = ArrayAdapter(this, android.R.layout.simple_list_item_1, chosenDegree2.getYears().get(1).getStringListSemester1())
        Log.println(Log.DEBUG,"degree",  "Chosen degree is "+chosenDegree2.getYears().get(1).getStringListSemester1().toString())
